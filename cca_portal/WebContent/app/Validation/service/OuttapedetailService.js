/**
 * Created by Qinglanhui on 2018/10/30.
 */
/**
 * Created by Qinglanhui on 2018/9/5.
 */
angular.module('app.Validation').service("OuttapedetailService", function($http, $q , APP_CONFIG) {
    /**
     * 下载模板
     */
    ...
    //下边的 vfs Download
    this.getvfsDown = function(timesta) {
        // console.log(id)
        var d = $q.defer();
        $http({
            method : 'GET',
            url : APP_CONFIG.baseUrl + '/api/otaExcelAllocationVFS/',
            headers: {
                'Authorization' : 'Bearer '+ sessionStorage.getItem("token")
            },
            params : timesta,
